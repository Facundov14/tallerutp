<%-- 
    ...
    Created on : 10 jun. 2022, 02:24:08
    Author     : Jose
--%>
            ...
            <div class="principal">
                <div class="general">
                    ...
                    <form class="formulario" action="ControladorCliente">
                        ...
                        <label class="form-label" for="nombreRepuesto">Marca del equipo: </label>
                        ...
                        <input type="hidden" name="codigoUsuarioEquipo" value="${equipo.getUsuarioEquipo().getCodigoUsuario()}">
                        <input type="hidden" name="codigoEquipo" value="${equipo.getCodigoEquipo()}">

                        <label class="form-label" for="descripcionEquipo">Ingresa la descripcion del equipo:</label>
                        <textarea class="form-control" name="descripcionEquipo" maxlength="200" cols="40" rows="5" style="resize: none;">${equipo.getDescripcionEquipo()}</textarea><br>
